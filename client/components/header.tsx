...
const Header = () => {
  ...
  return (
    <div className="z-50 w-full py-6">
      <div className="container mx-auto px-4 flex justify-between items-center">
        <Logo />
        <nav className="py-2 hidden md:flex items-center bg-transparent backdrop-blur-[6px] overlay sm-only:hidden space-x-8 border border-border rounded-full px-2">
